...
// RichTextEditor — Tiptap wrapper for the compose body. Keeps only the
// email-safe formats (bold + italic) and undo/redo; headings, lists, code,
// quotes and links are disabled so the editor stays plain and predictable.
...
import { Bold, Italic, Undo2, Redo2 } from "lucide-vue-next";
