...
// locale-independent signals (IMAP SPECIAL-USE flags, Gmail system labels,
// Graph well-known folders) — so they can be shown in the app's language
// regardless of the provider's own folder name. Unknown roles return null so
// callers fall back to the provider's folder name.
